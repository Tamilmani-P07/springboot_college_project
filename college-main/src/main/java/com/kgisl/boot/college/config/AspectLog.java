package com.kgisl.boot.college.config;
...
public class AspectLog implements ThrowsAdvice {
    ...
    @Pointcut("execution(* com.kgisl.boot.college.service.*.*(..))")
    public void controller() {
    }
    @Pointcut("execution(* com.kgisl.boot.college.service.*.*(..))")
    protected void allMethod() {
    }
    @Before("execution(* com.kgisl.boot.college.service.*.*(..))")
...
@AfterThrowing(pointcut="execution(* com.kgisl.boot.college.controller.*.*(..))", 
        throwing="excep")
